...
if __name__ == '__main__':
    ...
    config = Config({
        # dataset path
        "train_dataset": "csiq", # kadid10k, koniq10k, livec, tid2013, spaq, csiq
        "test_dataset" : "livec", 

        # LIVE
        "live_path": "../all_dataset/live/",
        "live_label": "./data/live/live_label.txt",
        ...
        "ckpt_path": "./output_csiq2livec/models/",               # directory for saving checkpoint
        "log_path": "./output_csiq2livec/log/",
        "log_file": ".log",
        "tensorboard_path": "./output_csiq2livec/"
    })
    ...
    if config.train_dataset == 'livec':
        ...
        from data.CSIQ.csiq_cross import CSIQ
        ...
        with open(label_train_path, 'r') as listFile:
            for line in listFile:
                ...
                if dis not in train_name:
                    train_name.append(dis)
        TrainDataset = CSIQ
    elif config.train_dataset == 'live':
        from data.live.live_cross import LIVE
    ...
    for epoch in range(0, config.n_epoch):
        ...
        writer.add_scalars("Metrics/Loss", {"Train": loss_val}, epoch)
        writer.add_scalars("Metrics/SRCC", {"Train": rho_s}, epoch)
        writer.add_scalars("Metrics/PLCC", {"Train": rho_p}, epoch)
        ...
        if (epoch + 1) % config.val_freq == 0:
            ...
            writer.add_scalars("Metrics/Loss", {"Test": loss}, epoch)
            writer.add_scalars("Metrics/SRCC", {"Test": rho_s}, epoch)
            writer.add_scalars("Metrics/PLCC", {"Test": rho_p}, epoch)
